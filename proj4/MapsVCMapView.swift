...
//
//  MapsVCMapView.swift -- This swift file contains an extenstion of the MapsViewController.
//  It contains all the functions responsible for placing all the pins on the maps and for 
//  opening other apps in order to vist the website, call, or get directions.
